...
import { Route as TodolistImport } from './routes/todolist'
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/login' | '/register' | '/todolist'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/login' | '/register' | '/todolist'
  id: '__root__' | '/' | '/login' | '/register' | '/todolist'
